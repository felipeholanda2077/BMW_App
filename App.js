    ...
    return (
      <ScrollView>
        ...
        <View style={{justifyContent: "space-around", display: 'flex', flex: 1, flexDirection: 'row', margin: 10,}}>
              <Button color='black' borderRadius='100' title='        HOME                         ' width='150' height='50' />
              ...
              <Text style={{color: 'blue', fontSize: 25, marginLeft: 100 , textAlign: 'left',}}>BEM-VINDO</Text>
            </View>

            <Text style={{ textAlign: 'center',color: 'black', fontSize: 20, textAlign: 'center' }}>MY BMW APP</Text>
