...
class App extends Component {
  render() {
    ...
    let Bmw4 = "https://www.bmw.com.br/content/dam/bmw/common/all-models/m-series/series-overview/bmw-m-series-seo-overview-model-carousel-06.jpg";
    let BmwF = "https://www.bmw.com.br/content/dam/bmw/common/all-models/i-series/i4/navigation/bmw-i4-mini-landingpage-modelfinder.png";
    ...
    let Masculino = []
    for (let i = 0; i < 1; i++) {
      Masculino.push(<Image style={{ width: 530, height: 350,margin: 10, borderRadius: 5 }} source={{ uri: BmwF }} />)
    }

    //Carro do futuro
    let Futuro = []
    for (let i = 0; i < 1; i++) {
      Futuro.push(<Image style={{ width: 395, height: 350,margin: 10, borderRadius: 5 }} source={{ uri: BmwF2 }} />)
    }

    let Icone = []
    for (let i = 0; i < 1; i++) {
      Icone.push(<Image style={{alignItems: 'center', width: 250, height: 100, margin: 10, borderRadius: 5 }} source={{ uri: IconeM }} />)
    }

    //Redes sociais Footer
    let RedesSociais = []
    for (let i = 0; i < 1; i++) {
      RedesSociais.push(<Image style={{alignItems:'center', width: 390, height: 100, margin: 10, borderRadius: 10}} source={{ uri: Redes }} />)
    }
    ...
    return (
      <ScrollView>
        <View>
          <Text style={{ color: 'black', fontSize: 20, textTransform: 'uppercase', margin: 7, paddingTop: 20 }}>My BMW App</Text>
          ...
          <Text style={{ color: 'black', fontSize: 10, textAlign: 'center'}}>---------------------------------------------------------------------------------------------------------</Text>
